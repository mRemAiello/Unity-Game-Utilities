...
namespace GameUtils
{
    public abstract class GameEventAsset<T1, T2, T3, T4, T5> : GameEventAssetBase
    {
        [NonSerialized] protected List<EventTuple> _runtimeListeners = new();
        [NonSerialized] protected List<(T1, T2, T3, T4, T5)> _callHistory;
        ...
        protected Action<T1, T2, T3, T4, T5> _onInvoked;
        ...
        [ShowInInspector, Group("debug"), TableList(AlwaysExpanded = true), ReadOnly] public List<(T1, T2, T3, T4, T5)> CallHistory => _callHistory;
        ...
        public virtual void Invoke(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5)
        {
            ...
            _onInvoked?.Invoke(param1, param2, param3, param4, param5);
        }
    }
}
