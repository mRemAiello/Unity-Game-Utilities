...
namespace GameUtils
{
    public abstract class GameEventAsset<T1, T2, T3, T4> : GameEventAssetBase
    {
        [NonSerialized] protected List<EventTuple> _runtimeListeners = new();
        [NonSerialized] protected List<(T1, T2, T3, T4)> _callHistory;
        ...
        protected Action<T1, T2, T3, T4> _onInvoked;
        ...
        [ShowInInspector, Group("debug"), TableList(AlwaysExpanded = true), ReadOnly] public List<(T1, T2, T3, T4)> CallHistory => _callHistory;
        ...
        public override void ResetData()
        {
            ...
            _callHistory = new List<(T1, T2, T3, T4)>();
        }

        public void AddListener(MonoBehaviour caller, Action<T1, T2, T3, T4> action)
        {
            if (action == null)
            {
        ...
        public virtual void Invoke(T1 param1, T2 param2, T3 param3, T4 param4)
        {
            ...
            this.Log($"Invoked with params: {param1}, {param2}, {param3}, {param4}", this);

            //
            _callHistory ??= new List<(T1, T2, T3, T4)>();
            _callHistory.Add((param1, param2, param3, param4));
            _currentValue = param1;
            _currentValue2 = param2;
            _currentValue3 = param3;
            _currentValue4 = param4;
            _onInvoked?.Invoke(param1, param2, param3, param4);
        }
    }
}
